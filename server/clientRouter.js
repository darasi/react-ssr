...
const makeup = (req,store,createApp,html) => {
...
const clientRouter = async(req,res,next) => {
  ...
  let isMatch = getMatch(routesConfig,req.url);
  if(isMatch){
    let renderedHtml = await makeup(req,store,createApp,html);
